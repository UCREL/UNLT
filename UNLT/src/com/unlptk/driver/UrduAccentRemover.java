...
/**
 * Class to remove Aaraab (accents) from URDU text.
 * @author Rizwan Iqbal
 *
 */

public class UrduAccentRemover {
	
	public static void main(String[] args) {	       
	    	String test = "  اِنصاف کَرنے مُنقلَب جَہَنم";
	        System.out.println("Before: "+test);
	        test=new UrduAccentRemover(test).getOutput();
	 ...
	 private String input;
	    ...
	    /**
	     * UrduAccentRemover constructor
	     * @param input String
	     */
	    public UrduAccentRemover(String input){
	        this.input=input;
	        this.output=normalize();
	    }

	    /**
	     * normalize Method - Short method, but you can't specifically mention your
	     * own aaraab....it will remove all by default.
	     * @return String
	     */
	   ...
	   /* */
	    /**
	     * normalize Method....its longer..you can use it, if you want to define specific 
	     * aaraab....
	     * @return String
	     *//*
	    private String normalize(){
